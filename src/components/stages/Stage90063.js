        ...
        <main className={styles.stageContainer}>
            ...
            {(userAuth.lastStage > stageId || userAuth.lastSection >= 2) && (
                <div className={styles.sectionBox}>
                    ...
                    <p>
                        That's the last boundary that humanity might ever need
                        to push: the dependency of the body. Luckily, there
                        already exists an analogous state: the sleep state. Even
                        during the most intense and bizarre dreams, humans can
                        still find a sense of consciousness and recognize
                        themselves in that immaterial realm.
                    </p>
                    <p>
                        The severance of awareness is never an obstacle, as a
                        constant perception of the same physicality doesn't
                        appear to be essential for that recognition. After all,
                        they change and decay and sometimes become
                        unrecognizable to others but not to themselves thanks to
                        a sense of continuity to being.
                    </p>
                    <p>
                        The next logical question must be how you can experience
                        that continuity when the dissection processes are
                        detrimental to your natural processes. And while all
                        that may be the ultimate goal, there is still a much
                        more pressing problem for identity which arises since
                        for a consciousness to desire permanence there must be
                        an agent aware of its limits, and ostensively unique as
                        well.
                    </p>
